...
// 3 most common directories to be used in FileManager
/*
...
class LocalFileManager {
    ...
    init () {
        createFolderWhenNeeded()
    }
    
    func createFolderWhenNeeded () {
        guard
...
class FileManagerViewModel: ObservableObject {
    ...
    func getImageFromFileManager() {
        print("func getImageFromFileManager")
        image = manager.getImage(name: imageName)
    }
    
    func saveImage() {
        print("fun vm.saveImage")
